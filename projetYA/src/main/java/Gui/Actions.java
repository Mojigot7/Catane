...
public class Actions extends JFrame {
    ...
    private class Debut {
        ...
        public Debut() {
            ...
            finDeTour.addActionListener(event -> {
                ...
                principale.getInformationJoueur().getDeveloppement().setQuantité("chevalier",
                        suivant.getDev().getNbChevalier());
                principale.getInformationJoueur().getDeveloppement().setQuantité("invention",
                        suivant.getDev().getNbInvention());
                principale.getInformationJoueur().getDeveloppement().setQuantité("monopole",
                        suivant.getDev().getNbMonopole());
                principale.getInformationJoueur().getDeveloppement().setQuantité("pdv",
                        suivant.getDev().compterPtsDeVictoire());
                principale.getInformationJoueur().getDeveloppement().setQuantité("construction",
                        suivant.getDev().getNbConstructiondeRoute());
    ...
    public class ChoixActions {
        ...
        public ChoixActions() {
            poser.setEnabled(principale.getJoueurCourant().possedeColonie()
                    || principale.getJoueurCourant().possedeRoute() || principale.getJoueurCourant().possedeVille());
            poser.revalidate();
            construire.setEnabled(principale.getJoueurCourant().peutAcheterColonie()
                    || principale.getJoueurCourant().peutAcheterRoute()
                    || principale.getJoueurCourant().peutAcheterVille());
            developpement.setEnabled(principale.getJoueurCourant().peutCreeCarteDev()
                    || principale.getJoueurCourant().getDev().getStock().size() > 0);
        ...
        public Poser() {
            ...
            route.addActionListener(event -> {
                principale.getJoueurCourant().getInventaire().getBatiment().replace("ROUTE",
                        principale.getJoueurCourant().getInventaire().getBatiment().get("ROUTE") - 1);
                colonie.setEnabled(false);
                ville.setEnabled(false);
                retour.setEnabled(false);
                principale.getInformationJoueur().getBatiment().setQuantité("route",
            ...
            colonie.addActionListener(event -> {
                principale.getJoueurCourant().getInventaire().getBatiment().replace("COLONIE",
                        principale.getJoueurCourant().getInventaire().getBatiment().get("COLONIE") - 1);
                route.setEnabled(false);
                ville.setEnabled(false);
                retour.setEnabled(false);
                principale.getInformationJoueur().getBatiment().setQuantité("colonie",
            ...
            ville.addActionListener(event -> {
                principale.getJoueurCourant().getInventaire().getBatiment().replace("VILLE",
                        principale.getJoueurCourant().getInventaire().getBatiment().get("VILLE") - 1);
                principale.getJoueurCourant().getInventaire().getBatiment().replace("COLONIE",
                        principale.getJoueurCourant().getInventaire().getBatiment().get("COLONIE") + 1);
                route.setEnabled(false);
                colonie.setEnabled(false);
                retour.setEnabled(false);
                principale.getInformationJoueur().getBatiment().setQuantité("ville",
                        principale.getJoueurCourant().getNbVille());
                principale.getInformationJoueur().getBatiment().setQuantité("colonie",
                        principale.getJoueurCourant().getNbColonie());
            });
    ...
    public class Construire {
        ...
        public Construire() {
            ...
            route.addActionListener(event -> {
                principale.getJoueurCourant().getInventaire().getBatiment().replace("ROUTE",
                        principale.getJoueurCourant().getInventaire().getBatiment().get("ROUTE") + 1);
                principale.getJoueurCourant().getInventaire().getRessource().replace("ARGILE",
                        principale.getJoueurCourant().getInventaire().getRessource().get("ARGILE") - 1);
                principale.getJoueurCourant().getInventaire().getRessource().replace("BOIS",
                        principale.getJoueurCourant().getInventaire().getRessource().get("BOIS") - 1);
                main.removeAll();
                main.add(new ChoixActions().getChoixActionsContent());
                main.revalidate();
                principale.getInformationJoueur().getBatiment().setQuantité("route",
                        principale.getJoueurCourant().getNbRoute());
                principale.getInformationJoueur().getRessource().setQuantité("ARGILE",
                        principale.getJoueurCourant().getNbArgile());
                principale.getInformationJoueur().getRessource().setQuantité("BOIS",
                        principale.getJoueurCourant().getNbBois());
            });
            ...
            colonie.addActionListener(event -> {
                ...
                principale.getJoueurCourant().getInventaire().getRessource().replace("BOIS",
                        principale.getJoueurCourant().getInventaire().getRessource().get("BOIS") - 1);
                principale.getJoueurCourant().getInventaire().getRessource().replace("LAINE",
                        principale.getJoueurCourant().getInventaire().getRessource().get("LAINE") - 1);
                principale.getInformationJoueur().getRessource().setQuantité("BLE",
                        principale.getJoueurCourant().getNbBle());
                main.removeAll();
                main.add(new ChoixActions().getChoixActionsContent());
                main.revalidate();
                principale.getInformationJoueur().getBatiment().setQuantité("colonie",
                ...
                principale.getInformationJoueur().getRessource().setQuantité("BOIS",
                        principale.getJoueurCourant().getNbBois());
                principale.getInformationJoueur().getRessource().setQuantité("LAINE",
                        principale.getJoueurCourant().getNbLaine());
                principale.getInformationJoueur().getRessource().setQuantité("BLE",
                        principale.getJoueurCourant().getNbBle());
            });
            ...
            ville.addActionListener(event -> {
                principale.getJoueurCourant().getInventaire().getBatiment().replace("VILLE",
                        principale.getJoueurCourant().getInventaire().getBatiment().get("VILLE") + 1);
                principale.getJoueurCourant().getInventaire().getRessource().replace("MINERAI",
                        principale.getJoueurCourant().getInventaire().getRessource().get("MINERAI") - 3);
                principale.getJoueurCourant().getInventaire().getRessource().replace("BLE",
                        principale.getJoueurCourant().getInventaire().getRessource().get("BLE") - 2);
                main.removeAll();
                main.add(new ChoixActions().getChoixActionsContent());
                main.revalidate();
                principale.getInformationJoueur().getBatiment().setQuantité("ville",
                        principale.getJoueurCourant().getNbVille());
                principale.getInformationJoueur().getRessource().setQuantité("MINERAI",
                        principale.getJoueurCourant().getNbMinerai());
                principale.getInformationJoueur().getRessource().setQuantité("BLE",
                        principale.getJoueurCourant().getNbBle());
            });
            content.add(retour);
    ...
    public class Developpement {
        ...
        public Developpement() {
            ...
            cree.addActionListener(event -> {
                principale.getJoueurCourant().getInventaire().getRessource().replace("MINERAI",
                        principale.getJoueurCourant().getInventaire().getRessource().get("MINERAI") - 1);
                principale.getJoueurCourant().getInventaire().getRessource().replace("LAINE",
                        principale.getJoueurCourant().getInventaire().getRessource().get("LAINE") - 1);
                principale.getJoueurCourant().getInventaire().getRessource().replace("BLE",
                        principale.getJoueurCourant().getInventaire().getRessource().get("BLE") - 1);
                principale.getJoueurCourant().getDev()
                        .creationCarteDev(principale.getJoueurCourant().getDev().getCarteDev());
                creationunique = false;
                main.removeAll();
                main.add(new ChoixActions().getChoixActionsContent());
                main.revalidate();
                principale.getInformationJoueur().getRessource().setQuantité("MINERAI",
                        principale.getJoueurCourant().getInventaire().getRessource().get("MINERAI"));
                principale.getInformationJoueur().getRessource().setQuantité("LAINE",
                        principale.getJoueurCourant().getInventaire().getRessource().get("LAINE"));
                principale.getInformationJoueur().getRessource().setQuantité("BLE",
                        principale.getJoueurCourant().getInventaire().getRessource().get("BLE"));
                principale.getInformationJoueur().getDeveloppement().setQuantité("chevalier",
                        principale.getJoueurCourant().getDev().getNbChevalier());
                principale.getInformationJoueur().getDeveloppement().setQuantité("invention",
                        principale.getJoueurCourant().getDev().getNbInvention());
                principale.getInformationJoueur().getDeveloppement().setQuantité("monopole",
                        principale.getJoueurCourant().getDev().getNbMonopole());
                principale.getInformationJoueur().getDeveloppement().setQuantité("pdv",
                        principale.getJoueurCourant().getDev().compterPtsDeVictoire());
                principale.getInformationJoueur().getDeveloppement().setQuantité("construction",
                        principale.getJoueurCourant().getDev().getNbConstructiondeRoute());
            });
            content.add(retour);
            retour.addActionListener(event -> {
                main.removeAll();
    ...
    public class CarteDev {
        ...
        public CarteDev() {
            ...
            consRoute.addActionListener(event -> {
                principale.getJoueurCourant().getInventaire().getBatiment().replace("ROUTE",
                        principale.getJoueurCourant().getInventaire().getBatiment().get("ROUTE") + 2);
    ...
    public class InventionPanel {
        ...
        public void choixRessrouces(String s) {
            if (count == 1) {
                principale.getJoueurCourant().getInventaire().getRessource().replace(s,
                        principale.getJoueurCourant().getInventaire().getRessource().get(s) + 1);
                principale.getInformationJoueur().getRessource().setQuantité(s,
                        principale.getJoueurCourant().getInventaire().getRessource().get(s));
        ...
        public void monopole(ArrayList<Joueur> j, String r1) {
            for (int i = 0; i < j.size(); i++) {
                if (j.get(i).getNom().equals(principale.getJoueurCourant().getNom()) == false) {
                    if (r1.equals("BOIS")) {
                        principale.getJoueurCourant().getInventaire().getRessource().replace(r1,
                                principale.getJoueurCourant().getInventaire().getRessource().get(r1)
                                        + j.get(i).getNbBois());
                        j.get(i).getInventaire().getRessource().replace(r1,
                                j.get(i).getInventaire().getRessource().get(r1) - j.get(i).getNbBois());
                    }
                    ...
                    if (r1.equals("ARGILE")) {
                        principale.getJoueurCourant().getInventaire().getRessource().replace(r1,
                                principale.getJoueurCourant().getInventaire().getRessource().get(r1)
                                        + j.get(i).getNbArgile());
                        j.get(i).getInventaire().getRessource().replace(r1,
                                j.get(i).getInventaire().getRessource().get(r1) - j.get(i).getNbArgile());
                    }
                    if (r1.equals("LAINE")) {
                        principale.getJoueurCourant().getInventaire().getRessource().replace(r1,
                                principale.getJoueurCourant().getInventaire().getRessource().get(r1)
                                        + j.get(i).getNbLaine());
                        j.get(i).getInventaire().getRessource().replace(r1,
                                j.get(i).getInventaire().getRessource().get(r1) - j.get(i).getNbLaine());
                    }

                    if (r1.equals("MINERAI")) {
                        principale.getJoueurCourant().getInventaire().getRessource().replace(r1,
                                principale.getJoueurCourant().getInventaire().getRessource().get(r1)
                                        + j.get(i).getNbMinerai());
                        j.get(i).getInventaire().getRessource().replace(r1,
                                j.get(i).getInventaire().getRessource().get(r1) - j.get(i).getNbMinerai());
                    }
                    if (r1.equals("BLE")) {
                        principale.getJoueurCourant().getInventaire().getRessource().replace(r1,
                                principale.getJoueurCourant().getInventaire().getRessource().get(r1)
                                        + j.get(i).getNbBle());
                        j.get(i).getInventaire().getRessource().replace(r1,
                                j.get(i).getInventaire().getRessource().get(r1) - j.get(i).getNbBle());
                    }
                }
            }
            main.removeAll();
